...
namespace XGame.Domain.Entities
{
    public class Jogo : EntityBase
    {
        ...
        private void ValidarIdentidade()
        {
            new AddNotifications<Jogo>(this)
                ...
                .IfNullOrInvalidLength(x => x.Genero, 1, 30, Message.X0_OBRIGATORIO_E_DEVE_CONTER_ENTRE_X1_E_X2_CARACTERES.ToFormat("Gênero", "1", "30"));
        }
